        ...
        <div className="w-full flex flex-col bg-white border-2 p-3 rounded-2xl gap-2">
            <div className="w-full flex items-center justify-between">
                ...
                <div className='flex items-center gap-3'>
                    <span className='text-sky-500 font-normal'>{order?._id}</span>
                    <FiCopy onClick={() => copyValue(order?._id)} className='cursor-pointer hover:animate-pulse' size={20} />
                </div>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
                ...
                <div className='flex items-center gap-3'>
                    <span className='text-sky-500 font-normal'>{`${order?.user}`}</span>
                </div>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
                ...
                <div className='flex items-center gap-3'>
                    <span className='text-sky-500 font-normal'>{moment(order.createdAt).fromNow()}</span>
                </div>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
                ...
                <div className='flex items-center gap-3'>
                    <span className='text-sky-500 font-normal'>{moment(order.createdAt).format("MMMM Do YYYY, h:mm:ss a")}</span>
                </div>
            </div>
