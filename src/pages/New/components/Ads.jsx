...
const Ads = () => {
  ...
  return (
    <>
      <div className="ads px-4 lg:px-20 my-14 flex flex-col md:flex-row gap-4" ref={ref}>
        <motion.div
          ...
          className="block1 w-full lg:w-[1500px] h-[511px] p-14"
        ...
        <div className="flex flex-col gap-4">
          <motion.div
            ...
            className='block2 w-full lg:w-[485px] h-[247px] p-10'
          ...
          <motion.div
            ...
            className='block3 w-full lg:w-[485px] h-[247px] p-10'
