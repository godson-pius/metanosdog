...
const Ads = () => {
  ...
  return (
    <>
      <div className="ads lg:px-20 md:px-8 my-14 flex gap-4 md:flex-wrap lg:flex-nowrap" ref={ref}>
        <motion.div
          ...
          className="block1 lg:w-[956px] md:w-[100%] lg:h-[511px] md:h-[380px] p-14"
        ...
        <div className="flex flex-col gap-4 md:w-[100%]">
          <motion.div
            ...
            className='block2 lg:w-[485px] md:w-[100%] lg:h-[247px] md:h-[380px] p-10'
          ...
          <motion.div
            ...
            className='block3 p-10 lg:w-[485px] md:w-[100%] lg:h-[247px] md:h-[380px]'
