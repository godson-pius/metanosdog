        ...
        <>
            <AnimatePresence mode='wait'>
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="top__products w-full grid grid-cols-4 items-center my-5 gap-5">
                    ...
                    <div className="product flex flex-col">
                        <img src={product2} alt="Meta Nosdog Product Image" width={300} />
                        <p className="category uppercase text-gray-400 text-xs mt-3">Chair</p>
                        <h2 className='mt-1 font-bold text-lg'>Minimal iconic chair</h2>
                        <div className="flex gap-3 items-center">
                            <p className="price text-[#7AC751]">$678</p>
                            <del className='text-gray-400 text-sm'>$100</del>
                        </div>
                    </div>
                    ...
                    <div className="product flex flex-col">
                        ...
                        <p className="category uppercase text-gray-400 text-xs mt-3">Chair</p>
                        <h2 className='mt-1 font-bold text-lg'>Dining chairs</h2>
                        <div className="flex gap-3 items-center">
                            <p className="price text-[#7AC751]">$378</p>
                            <del className='text-gray-400 text-sm'>$100</del>
                        </div>
                    </div>
                    ...
                    <div className="product flex flex-col">
                        ...
                        <p className="category uppercase text-gray-400 text-xs mt-3">Chair</p>
                        <h2 className='mt-1 font-bold text-lg'>Buskbo armchair </h2>
                        <div className="flex gap-3 items-center">
                            <p className="price text-[#7AC751]">$134</p>
                            <del className='text-gray-400 text-sm'>$100</del>
                        </div>
                    </div>
